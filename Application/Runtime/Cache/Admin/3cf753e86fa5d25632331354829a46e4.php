...
<div class="main-div">
    <form method="post" action="/jiiMade/index.php/Admin/Color/edit"enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
        <input type="hidden" name="id" value="<?php echo $data['id'] ?>">
            <tr>
                <td class="label">颜色名称</td>
                <td>
                    <input type="text" name="color_name" maxlength="60" value="<?php echo $data['color_name'] ?>" />
