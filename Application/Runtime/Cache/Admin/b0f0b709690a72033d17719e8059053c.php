...
<body>
<h1>
    <span class="">JiiHOME 管理中心</span>
    <span id="search_id" class="action-span1"></span>
    <div style="clear:both"></div>
</h1>
<div class="list-div">
    <div style="width: 100%;height: 400px;line-height: 400px;text-align: center;font-size: 30px;">jiiHome后台管理中心</div>
