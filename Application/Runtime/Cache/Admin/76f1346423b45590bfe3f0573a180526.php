            ...
            <tr>
                ...
                <td id="formula-list">
                    <li>
                        ...
                        <input type="text" name="formula-price[]" placeholder="计价单价" style="width: 100px;">
                        <input type="text" name="formula-total-price[]" placeholder="总计价" style="width: 100px;">
                        <input type="text" name="formula-unit[]" placeholder="计价单位" style="width: 50px;">
                        <input type="text" name="formula-remarke[]" placeholder="备注" style="width: 50px;">
                    </li>
                </td>
            </tr>
            <tr>
