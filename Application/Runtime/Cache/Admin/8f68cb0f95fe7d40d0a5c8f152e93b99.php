...
<div class="main-div">
    <form action="/jiimadeeee/index.php/Admin/Privilege/add.html" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                <td class="label">权限名称:</td>
                <td>
                    <input type='text' name='pri_name' maxlength="20" value='' size='27' /> <font color="red">*</font>
                </td>
            </tr>
            <tr>
               ...
               <td>
                 <select name="parent_id">
                    ...
                    <?php echo '<option value="'.$v['id'].'">'.str_repeat('-',4*$v['level']).$v['pri_name'].'</option>'; ?>
                    <?php endforeach; ?>
                 </select>
            </tr>
            <tr>
