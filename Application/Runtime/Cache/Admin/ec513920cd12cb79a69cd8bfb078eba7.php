...
<div class="main-div">
    <form action="/jiimadeeee/index.php/Admin/ArticleCategory/edit/id/1.html" method="post" name="theForm" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php if($v['id'] == $idData['id']){ continue; }else{ echo '<option '.$select.' value="'.$v['id'].'">'.$v['name'].'</option>'; } ?>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
