...
<div class="main-div">
    <form method="post" action="/jiimadeeee/index.php/Admin/Furniture/edit/id/1.html"enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td >
                    <select name="cate_id">
                        <option value="1" select="<?php echo ($data['cate_id'] == '1')?'selected':''; ?>">柜体</option>
                        <option value="2" select="<?php echo ($data['cate_id'] == '2')?'selected':''; ?>">门板</option>
                        <option value="3" select="<?php echo ($data['cate_id'] == '3')?'selected':''; ?>">饰面</option>
                    </select>
                    <span class="require-field">*</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td id="attr">
                    ...
                    <div id="attr-list<?php echo $index;?>" class="attr-list">
                        ...
                        <?php
 if($k1 == '1'){ echo " 单选 "; }else if($k1 == '2'){ echo " 加减 "; } ?>
