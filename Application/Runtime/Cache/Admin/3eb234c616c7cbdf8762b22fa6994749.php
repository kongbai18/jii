        ...
        <div width="90%" class="general-table" >
            ...
            <table class="module-top" cellspacing="0" cellpadding="0">
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $caPaWidth; ?>">产品类型</td>
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $caPaWidth; ?>"><?php echo $v['type']; ?></td>
                    <?php foreach($v['parameter'] as $k1 => $v1): ?>
        ...
        <div width="90%" style="display:none" class="general-table">
            ...
            <table class="module-top" cellspacing="0" cellpadding="0">
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $doParNum; ?>">产品类型</td>
                    <?php foreach($v['parameter'] as $k1 => $v1): ?>
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $doParNum; ?>"><?php echo $v['type']; ?></td>
                    <?php foreach($v['parameter'] as $k1 => $v1): ?>
        ...
        <div width="90%" style="display:none" class="general-table">
            ...
            <table class="module-top" cellspacing="0" cellpadding="0">
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $frParNum; ?>">产品类型</td>
                    <?php foreach($v['parameter'] as $k1 => $v1): ?>
                ...
                <tr class="module-info">
                    ...
                    <td style="width:<?php echo $frParNum; ?>"><?php echo $v['type']; ?></td>
                    <?php foreach($v['parameter'] as $k1 => $v1): ?>
