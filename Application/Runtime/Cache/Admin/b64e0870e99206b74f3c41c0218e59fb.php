...
<div class="main-div">
    <form method="post" action="/jiimadeeee/index.php/Admin/Admin/edit/id/1.html"enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
        <input type="hidden" name="id" value="<?php echo $data['id'] ?>">
            <tr>
                <td class="label">角色列表 :</td>
                <td>
                    <?php foreach($rData as $k => $v): if(in_array($v['id'],$arData)){ $check = 'checked="checked"'; }else{ $check = ''; } ?>
