 ...
 <form method="post" action="/jiimadeeee/index.php/Admin/Goods/goods_number/id/5.html" name="listForm" enctype="multipart/form-data">
       <table id="num-tal">
            ...
            <tr class="tron">
                ...
                <td align="center"><input type="text" name="reward[]" value=""></td>
                <td align="center"><input type="text" name="deduction[]" value=""></td>
           ...
           <?php foreach($gnData as $v): $goodsAttrId = explode(',',$v['goods_attr_id']);?>
              <tr class="tron">
                  ...
                  <td align="center"><input type="text" name="reward[]" value="<?php echo $v['reward']; ?>"></td>
                  <td align="center"><input type="text" name="deduction[]" value="<?php echo $v['deduction']; ?>"></td>
